...
export const MEMORY_FLUSH_APPEND_BLOCK_PREFIX = "MEMORY_FLUSH_APPEND:";

const MEMORY_FLUSH_OUTPUT_ONLY_HINT = `Generate ONLY the new durable memory content to append, prefixed with ${MEMORY_FLUSH_APPEND_BLOCK_PREFIX}; do not restate, reconstruct, or rewrite existing file contents.`;
const MEMORY_FLUSH_READ_ONLY_HINT =
  "Treat workspace bootstrap/reference files such as MEMORY.md, SOUL.md, TOOLS.md, and AGENTS.md as read-only during this flush; never overwrite, replace, or edit them.";
const MEMORY_FLUSH_REQUIRED_HINTS = [
  MEMORY_FLUSH_TARGET_HINT,
  MEMORY_FLUSH_APPEND_ONLY_HINT,
  MEMORY_FLUSH_OUTPUT_ONLY_HINT,
...
export const DEFAULT_MEMORY_FLUSH_SYSTEM_PROMPT = [
  ...
  "The session is near auto-compaction; capture durable memories before context is compacted.",
  MEMORY_FLUSH_TARGET_HINT,
  MEMORY_FLUSH_READ_ONLY_HINT,
  MEMORY_FLUSH_APPEND_ONLY_HINT,
  MEMORY_FLUSH_OUTPUT_ONLY_HINT,
